  ...
  if( /Android|webOS|iPhone|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
    ...
    var slider = $('#lightSlider').lightSlider({
		...
		onSliderLoad: function (el) {
			$("#lightSlider li.active").prev("li").addClass('previous'); 
			$("#lightSlider li.active").next("li").addClass('next'); 	
		},
		onAfterSlide: function (el) {
			$("#lightSlider li.previous").removeClass('previous'); 
			$("#lightSlider li.next").removeClass('next'); 
			$("#lightSlider li.active").next("li").addClass('next'); 
			$("#lightSlider li.active").prev("li").addClass('previous'); 
		}
    });
    ...
    var slider = $('#lightSlider').lightSlider({
		...
		onSliderLoad: function (el) {
			$("#lightSlider li.active").prev("li").addClass('previous'); 
			$("#lightSlider li.active").prev("li").prev("li").addClass('way_back'); 
			$("#lightSlider li.active").next("li").addClass('next'); 	
			$("#lightSlider li.active").next("li").next("li").addClass('way_up'); 
		},
		onAfterSlide: function (el) {
			$("#lightSlider li.previous").removeClass('previous'); 
			$("#lightSlider li.next").removeClass('next'); 
			$("#lightSlider li.way_up").removeClass('way_up'); 
			$("#lightSlider li.way_back").removeClass('way_back'); 
			$("#lightSlider li.active").next("li").addClass('next'); 
			$("#lightSlider li.active").next("li").next("li").addClass('way_up'); 
			$("#lightSlider li.active").prev("li").addClass('previous'); 
			$("#lightSlider li.active").prev("li").prev("li").addClass('way_back');
