...
<?php } ?>
	...
	<?php if ($full_width) { ?>
		...
		<?php } elseif($pagebreak_default_background_image) { ?>
		<div class="pagebreak pagebreak_default_background_image <?php if ($additional_pagebreak_classes) { echo $additional_pagebreak_classes; } ?>" style="background-image:url(<?php echo $pagebreak_default_background_image; ?>);<?php echo $pagebreak_background_attachment; ?>">
		<?php } else { ?>
	...
	<?php } elseif ($left_img) { ?>
		...
		<?php } elseif($pagebreak_default_background_image) { ?>
		<div class="pagebreak pagebreak_left pagebreak_default_background_image <?php if ($additional_pagebreak_classes) { echo $additional_pagebreak_classes; } ?>" style="background-image:url(<?php echo $pagebreak_default_background_image; ?>);<?php echo $pagebreak_background_attachment; ?>">
		<?php } else { ?>
	...
	<?php } elseif ($right_img) { ?>
		...
		<?php } elseif($pagebreak_default_background_image) { ?>
		<div class="pagebreak pagebreak_right pagebreak_default_background_image <?php if ($additional_pagebreak_classes) { echo $additional_pagebreak_classes; } ?>" style="background-image:url(<?php echo $pagebreak_default_background_image; ?>);<?php echo $pagebreak_background_attachment; ?>">
		<?php } else { ?>
